...
df = pd.read_csv('C:\\Users\\86300\\PycharmProjects\\ioc-app\\data\\result.csv', sep=',')
resultwithmatches_df = pd.read_csv('C:\\Users\\86300\\PycharmProjects\\ioc-app\\data\\resultwithmatches.csv', sep=',')
users_df = pd.read_csv('C:\\Users\\86300\\PycharmProjects\\ioc-app\\data\\users.csv', sep=',')
